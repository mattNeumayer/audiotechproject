...
class VSTPlugin(object):
  ...
  def __init__(self, filename, audio_callback = basic_callback):
    ...
    try:
      ...
      print(self.__lib)
      test = self.__lib.VSTPluginMain(self.__callback)
  ...
  def get_name(self):
    name = c_char_p(b'\0' * VstStringConstants.kVstMaxEffectNameLen)
    self.dispatcher(byref(self.__effect), AEffectXOpcodes.effGetEffectName, 0, 0, name, 0.)
    return name.value

  def get_vendor(self):
    name = c_char_p(b'\0' * VstStringConstants.kVstMaxVendorStrLen)
    self.dispatcher(byref(self.__effect), AEffectXOpcodes.effGetVendorString, 0, 0, name, 0.)
    return name.value

  def get_product(self):
    name = c_char_p(b'\0' * VstStringConstants.kVstMaxProductStrLen)
  ...
  def get_program_name_indexed(self, index):
    name = c_char_p(b'\0' * VstStringConstants.kVstMaxProgNameLen)
  ...
  def get_parameter_name(self, index):
    name = c_char_p(b'\0' * VstStringConstants.kVstMaxParamStrLen)
